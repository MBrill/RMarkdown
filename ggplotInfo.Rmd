...
Als Beispiel fürHistogramme in diesem Fall verwenden wir den Datensatz
...
Das Package *ggplot* wurden von Wickham entwickelt. Das Package verfolgt eine ganz andere Herangehensweise an die Erstellung von Grafik.
...
die wir zu Beginn erzeugt haben.

Wir mussten für die Ausgabe der absoluten Häufigkeiten keine
Tabelle anlegen. Die Funktion *geom_bar* nimmt die Werte entgegen
...
Wir möchten alle Werte zwischen 1 und 7 auf der x-Achse
sehen, dazu verwenden wir *scale_x_discrete*. Und mit *labs* legen wir einen Titel
für das Bild und Achsenbeschriftungen fest. Und da wir jetzt gleich
noch weitere Veränderungen an unserer Abbildung vornehmen möchten speichern
...
können wir Eigenschaften auf der x-Achse verändern. Wir übergeben einen
...
der wir eine Überschrift und Achsenbeschriftungen übergeben.
...
wir ein horizontale oder vertikale Ausgabe erhalten. Natürlich ist es immer
...
Wir erstellen zuerst ein Balkendiagramm.
...
## Streuungsdiagramme
Die Wertepaare
in einem Streuungsdiagramm geben wir mit Hilfe des *geoms* *geom_point* aus.
