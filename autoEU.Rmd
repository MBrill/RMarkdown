...
Als Beispiel-Datensatz verwenden wir *autoEU*.
...
Wir wählen mit Hilfe der Funktion *sample_by_n* aus *rstatix* einige
Zeilen zufällig aus.
...
kable(sample_n_by(daten, Region, size=2), 
      align="l") %>%
...
Wir können die Kategorien auf der x-Achse auch verändern, indem wir
zum Beispiel *x=Zylinder* zuweisen.
...
verwenden wir neben *ggplot* auch *pairs* aus dem Default-Package *plot*.
...
durchführen muss, weshalb wir darauf verzichten.
Wir rufen *pairs* zweimal auf. Einmal für die Ausgabe im Markdown
und ein zweites Mal für das Speichern in einem png-File.
