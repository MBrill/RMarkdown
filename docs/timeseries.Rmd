...
In R gibt es ein Array *month.abb* mit englischen Abkürzungen für die Monatsnamen. Wir möchten hier deutsche Beschriftungen, also besetzen wir selbst ein Feld. Diese Abkürzungen bauen wir 
mit  *scale_x_continous* in die Grafik ein.
...
möchten übergeben wir die Option *stat="identity"*.
