...
Wir wiederholen diese Ausgaben und erstellen eine grafische Darstellung
eines 95%-Konfidenzintervalls. Diese Abbildung verwenden wir beim Thema
...
PerPlot <- ggplot() +
  ...
  geom_vline(xintercept=pmin) +
  labs(
    title= "Standardnormalverteilung - 95% Konfidenzintervall",
    y=""
  ) 
...
ggsave(filename="konfidenzNormal.png", plot=last_plot(), device="png",
       path="images/", width=16, height=9, units="cm")
```