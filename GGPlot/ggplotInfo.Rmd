...
*y = after_stat(prop), group=TRUE* hinzu. Damit legen wir fest, dass wir auf der y-Achse
*Anteile*, *proportions*, ausgeben möchten. 
Diese Anteile sollten, falls eine Gruppierung vorhanden
ist pro Gruppe bestimmt werden. Dafür sorgt *group=TRUE*.
...
ggplot(liefer, aes(x=Lieferzeiten)) + 
  stat_ecdf(geom = "step", pad=TRUE, color=myPalette[3], linewidth=2) +
  scale_x_discrete(breaks=seq(1, 7)) +
  labs(
...
wir Streuungsdiagramme erstellen können und eine Legende
