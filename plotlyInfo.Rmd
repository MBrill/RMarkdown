...
Das Package *plotly* verwendet das Package *htmlwidgets* und produziert
...
und eine Web-Anwendung implementieren.
...
Und wir können die Abbildung als png-Datei abspeichern.
...
plot_ly(x = h$mids, y = h$counts) %>%
  ...
  layout(
    title="Körpergrößen von Frauen mit Klassenbreiten nach Freedman-Diaconis",
    bargap = 0)
```
