...
dass Sie die Videos *Arbeiten mit data.frames*, *Arbeiten mit tibbles* und *Daten importieren* kennen.
...
*read_csv* einfach durch *read_excel*:

```{r readxls, echo=TRUE}
library(readxl)
carX <- read_excel("data/Auto.xlsx", na= "?")
carX
```
