...
uiSources <- function(id = IDSRC){
  tagList(
    p(
      ...
      br(),
      HTML('<center><h3><a href="https://www.oreilly.com/library/view/python-artificial-intelligence/9781789539462/assets/462dc4fa-fd62-4539-8599-ac80a441382c.png" target="_blank">Picture</a></h3></center>'),
      br(),
      HTML('<center><h3><a href="https://www.embedded-robotics.com/wp-content/uploads/2022/01/Iris-Dataset-Classification.png" target="_blank">Picture</a></h3></center>')
    )
