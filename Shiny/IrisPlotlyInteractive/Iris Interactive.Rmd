...
<!--################################################-->
<!--Click "Run Document" for the interactive version-->
<!--################################################-->
...
ID is handed to the UI and server function.
These functions will define the content of the tab. 
...
serverTab1 <- function(id = IDTAB1){
  # The namespace for the server is defined by the id. It is not necessary to address UI elements in the same way as in the uiTab1 function. All elements are addressable by input$<elementID>.
  moduleServer(id, function(input, output, session) {
    # ...
  })
}

# In order to use these functions as a separate Shiny App:
#   
# ui <- shinyUI(
#   uiTab1()
# )
