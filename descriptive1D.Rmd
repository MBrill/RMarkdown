...
# Einleitung
Sie haben sicher bereits eine Lehrveranstaltung zum Thema Wahrscheinlichkeitsrechnung und Statistik in ihrem Studium gehört. Dieses Dokument ist kein Ersatz für diese Lehrveranstaltungen, sondern hat das
Ziel die in einer solchen Lehrveranstaltung eingeführten Begriffe und Techniken nochmals in Erinnerung zu rufen, in einer einheitlichen Notation zu beschreiben und zu zeigen, wie wir diese Konzepte mit Hilfe R einsetzen können.

Merkmale, Merkmalsträger, Stichproben, Skalen.

# Daten
Als Beispieldaten verwenden wir einige der Literatur entnommenen
Daten. Sie finden die Daten in der Lernplattform OLAT und können so
die Anweisungen in R selbst nochmals durchführen. 
Die R-Anweisungen in diesem Text gehen davon aus,
dass die *csv*-Dateien im Unterverzeichnis *data* liegen.

## Lieferzeiten
Diese Daten sind [@bamberg_93] entnommen. Sie wurden aus dem Buch
abgetippt und als csv abgespeichert. Der Datensatz enthält
eine Spalte mit kardinalen Daten.

## Familienstand
Als Beispiel für nominale Daten betrachten wir den Datensatz
*Familienstand*, der [@benesch_13] entnommen ist.

## Körpergrößen von Frauen
...
mit *count*.
*Tidyverse* kann wie gewohnt mit Hilfe von Funktionsaufrufen verwendet werden. 
Sehr mächtig ist das Pipeline-Konzept in *dplyr*.
