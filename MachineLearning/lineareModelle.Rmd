...
# Vorbemerkungen
Dieses Dokument ist eine interne Version, mit der wir nachvollziehen, wie wir mit *lm* und den Funktionen in *modelr* vorgehen. Parallel wird es dann ein Dokument geben, das ausgeteilt werden kann. Die Darstellung folgt in weiten Teilen
[@wickham_16]

Als Datensatz verwenden wir das Beispiel aus den Folien. den Datensatz *Luftfeuchtigkeit*.

```{r daten, echo=FALSE, warnings=FALSE}
...
ggsave(filename="wassergehalt1.png", 
       plot=last_plot(), 
       device="png",
       path="../images/", 
       width=16, height=9, 
...
ggsave(filename="wassergehaltModell3.png", 
       plot=last_plot(), 
       device="png",
       path="../images/", 
       width=16, height=9, 
...
mehr Werte für ein potentielles Modell, geben dies aus und färben die Geraden auch mit der Abweichung, die wir durch Einsetzen in die
...
ggsave(filename="wassergehaltModell1.png", 
       plot=last_plot(), 
       device="png",
       path="../images/", 
       width=16, height=9, 
...
ggsave(filename="wassergehaltModell2.png", 
       plot=last_plot(), 
       device="png",
       path="../images/", 
       width=16, height=9, 
...
ggsave(filename="wassergehaltResPlot.png", 
       plot=last_plot(), 
       device="png",
       path="../images/", 
       width=16, height=9, 
