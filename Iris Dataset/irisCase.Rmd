...
Da wir später klassifizieren möchten erzeugen wir
einen Tibble, der die Information über die Spezies
nicht mehr enthält.
...
des Datensatzes. Insgesamt liegen 150 Zeilen vor, dabei gehören jeweils 50 zu jeder der drei Spezies.
...
Die folgende Darstellung der Verfahren orientiert sich an [@tibshirani_13] und [@kabacoff_15].
...
ggsave(filename="irisScatterSepalPetal.png",
       plot=last_plot(), 
       device="png",
       path="../images/", 
       width=16, 
...
ggsave(filename="irisScatterSepal.png",
       plot=last_plot(), 
       device="png",
       path="../images/", 
       width=16, 
...
ggsave(filename="irisScatterPetal.png",
       plot=last_plot(), 
       device="png",
       path="../images/", 
       width=16, 
...
ggsave(filename="irisggSPLOM.png",
       plot=last_plot(), 
       device="png",
       path="../images/", 
       width=16, 
...
ggsave(filename="irisknnHeat.png", 
       plot=last_plot(), 
       device="png",
       path="../images/", 
       width=16, height=9, 
...
ggsave(filename="irisknnHeat3.png", 
       plot=last_plot(), 
       device="png",
       path="../images/", 
       width=16, height=9, 
...
ggsave(filename="irisknnHeat13.png",
       plot=last_plot(), 
       device="png",
       path="../images/", 
       width=16, height=9, 
...
ggsave(filename="irisScatterPetalCorrect.png", 
       plot=last_plot(), 
       device="png",
       path="../images/", 
       width=16, 
...
ggsave(filename="irisScatterPetalPred.png", 
       plot=last_plot(), 
       device="png",
       path="../images/", 
       width=16, 
...
Die Funktion dafür finden wir im Package *randomForest*.
Achten Sie darauf, dass dieses Notebook voraussetzt, dass dieses Package
installiert ist.
...
ggsave(filename="irisranForHeat.png", 
       plot=last_plot(), 
       device="png",
       path="../images/", 
       width=16, height=9, 
...
ggsave(filename="irisSVMHeat.png", 
       plot=last_plot(), 
       device="png",
       path="../images/", 
       width=16, height=9, 
...
ggsave(filename="irisKMScatter.png", 
       plot=last_plot(), 
       device="png",
       path="../images/", 
       width=16, height=9, 
